...
Our report finds that the maximum amount of winnings possible only betting before the race on the winning horse is 12,698.87. Your initial investment was 437.14+22.45 = 459.59, (or 874.92 if you include your liability), so your percentage return is 2750%.
...
A beautiful analysis on whether such gambling is worth doing is Daniel Bernoulli's "Exposition of a New Theory on the Measurement of Risk" from 1738. A link is attached below. 
